...
Please make sure to update this README.md, STRUCTURE.md and SCIENCE.md after significant code changes.
...
See [SCIENCE.md](SCIENCE.md) for the underlying math/physics and [STRUCTURE.md](STRUCTURE.md) for the codebase layout.
