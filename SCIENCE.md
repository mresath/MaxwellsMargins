...
Please make sure to update this SCIENCE.md and README.md/STRUCTURE.md after significant code changes.
...
produce a field with genuine in-plane components - a fundamentally different, vector-valued
field unlike every other B source here, and out of scope for this app's existing
scalar (signed, in/out of page) B-field model. Rather than introduce $\mu_0$ and an
artificial dipole moment, its
